...
export function SignupScreen() {
  const [step, setStep] = useState('start'); // 'start' | 'details'
      ...
      <div className="auth-card auth-card-lg">
        ...
        {step === 'start' ? (
          <>
            ...
            <p className="auth-subtitle">Start growing on LinkedIn with AI-powered insights</p>
            ...
            <form onSubmit={handleEmailSubmit} className="auth-form">
              ...
              <button type="submit" className="auth-button-primary" disabled={oAuthLoading}>
                Continue
              </button>
            </form>
            ...
            <p className="auth-footer">
              ...
              <a className="auth-link" onClick={() => navigate('/login')}>Sign in</a>
            </p>
          </>
        ) : (
          <>
            ...
            <p className="auth-footer">
              <a className="auth-link" onClick={() => navigate('/login')}>Already have an account? Sign in</a>
            </p>
          </>
        )}
      </div>
